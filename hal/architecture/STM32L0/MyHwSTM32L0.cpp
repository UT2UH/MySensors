...
#if defined(SENSEBENDER_GW_STM32L0_V1)
...
int8_t hwCPUTemperature(void)
{
	...
	return static_cast<int8_t>(((temperature / 1000) - MY_STM32L0_TEMPERATURE_OFFSET) /
	                           MY_STM32L0_TEMPERATURE_GAIN);
}
